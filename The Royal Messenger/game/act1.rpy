...
label act1start:
    "The soft morning sun shines down on the people of the kingdom. People who need their mail."

    "You weave your way through crowded streets, handing letters to merchants, artisans, and performers."

    "Opening your satchel, you find an envelope that’s marked different from the others. It bears the royal seal."

    "You run to the castle, and pass through its heavily guarded gates."
    ...
    "Could you go tell the knight at the front gates to come speak to me?"
    ...
    "Sorry, I’ve been stationed here at the front gates, and I can’t leave my post."

    "But now I’m curious. Could you go find out why the princess asked to see me?"
